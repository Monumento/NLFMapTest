...
public class Main extends SimpleApplication implements ActionListener {
    ...
    public static void displayPart(int i, int j, int k) {
    ...
    //Server Client Setup
    //TCP IP
    public static ClientThread clientNorth, clientSouth, clientWest, clientEast;
    public static ClientThread[] playerClient;
    //JMS
